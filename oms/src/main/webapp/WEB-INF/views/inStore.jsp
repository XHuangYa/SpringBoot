                    ...
                    <div class="form-group  ">
                        <div class="row">
                            ...
                            <div class="col-md-2 has-feedback "  >
                                <input  name="beginTime " id="search_beginTime " type="text " placeholder="精确到年月日时分秒 "  class="form-control input-sm "  />
                                <span  class="glyphicon glyphicon-calendar form-control-feedback " ></span>
                            </div>

                            <label class="control-label col-md-1">结束时间:</label>
                            <div class="col-md-2 has-feedback " >
                                <input  name="endTime " id="search_endTime " type="text " placeholder="精确到年月日时分秒 " 	class="form-control  input-sm " />
                                <span  class="glyphicon glyphicon-calendar form-control-feedback"></span>
                            </div>
                            <div class="col-md-1  col-md-offset-1 has-feedback " style="color: white" >
                                <button class="btn btn-primary "   style="width: 80px;  text-align: left;"type="button " id="searchBtn " >查&nbsp;询</button>
                                <span class="glyphicon glyphicon-search form-control-feedback"></span>
                            </div>
                            <div class="col-md-1 has-feedback "  style="color: white"   >
                                <button disabled class="btn btn-primary "    style="width: 80px; background-color: grey; border-color: grey; text-align: left;" type="button " id="resetSearchBtn " > 重&nbsp;置 </button>
