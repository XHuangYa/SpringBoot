...
<!-- 查询框 start -->
<div class="panel-body" style="padding-bottom:0px;width: 1232px">
                ...
                <form id="searchBasecodeForm" name="searchBasecodeForm" class="form-horizontal">
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-2 ">
                                <input oninput="checkInputl()" type="text" class="form-control  input-sm "
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" style="margin-right: 30px">
                    ...
                    <div class="form-group form-group-sm">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" name="codeType" id="codeType" oninput="check()"
                                   onmouseleave="checkInputing()" onkeyup="this.value=this.value.replace(/\s+/g,'')"
                                   placeholder="请输入..."/>
                        </div>

                        <label class="control-label col-sm-2">类别名称:</label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control" name="codeName" id="codeName" oninput="check()"
                                   onmouseleave="checkInputing()" onkeyup="this.value=this.value.replace(/\s+/g,'')"
                                   placeholder="请输入..."/>
                        </div>
                    </div>
                ...
                <div class="form-group form-group-sm">
                    <button id="okCodeType" class="btn btn-default  col-sm-1 col-sm-offset-2  "
                            onclick="submitCodeType()" style="width: 80px">保存
                    </button>
                    <button id="resetedCodeType" class="btn btn-default  col-sm-1  col-sm-offset-2 "
                            onclick="resetCodeType()" style="width: 80px">重置
                    </button>
                    <button id="closeCodeTypeModel" type="button" class="btn btn-default col-sm-1  col-sm-offset-2 "
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" style="margin-right: 30px">
                    ...
                    <div class="form-group form-group-sm">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" name="dataCode" id="dataCode" oninput="check2()"
                                   onmouseleave="checkInputing2()" onkeyup="this.value=this.value.replace(/\s+/g,'')"
                                   placeholder="请输入..."/>
                        </div>

                        <label class="control-label col-sm-2">名称:</label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control" name="codeName" id="dataName" oninput="check2()"
                                   onmouseleave="checkInputing2()" onkeyup="this.value=this.value.replace(/\s+/g,'')"
                                   placeholder="请输入..."/>
                        </div>
                    </div>
                    ...
                    <div class="form-group form-group-sm">
                        <label class="control-label col-sm-2 ">类别代码:</label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control" name="codeType" id="codeTypeTwo" oninput="check2()"
                                   onmouseleave="checkInputing2()" onkeyup="this.value=this.value.replace(/\s+/g,'')"
                                   placeholder="请输入..."/>
                        </div>
                    </div>
                    ...
                    <div class="form-group form-group-sm" style="padding-left: 10px">
                        <div class="col-sm-12 ">
                            <textarea class="form-control" name="remark" id="remarkTwo"
                ...
                <div class="form-group form-group-sm">
                    <button id="okCode" class="btn btn-default  col-sm-1 col-sm-offset-2  " onclick="submitCode()"
                            style="width: 80px">保存
                    </button>
                    <button id="resetedCode" class="btn btn-default  col-sm-1  col-sm-offset-2 " onclick="resetCode()"
                            style="width: 80px">重置
                    </button>
                    <button id="closeCodeModel" type="button" class="btn btn-default col-sm-1  col-sm-offset-2 "
                            data-dismiss="modal">关闭
                    </button>
                </div>
            </div>
...
<div id='table-div1' style="width:45%;float:left;">
    <div class="btn-group" style="margin-top:10px; ">
        <button type="button" class="btn btn-default" onclick="addCodeTypeFun()" style="margin-left:16px"><span
                class="fa fa-plus fa-fw"></span> 新增</button>
        <button class="btn btn-default" onclick="deleteCodeTypeListFun()"><span
                class="fa fa-trash-o fa-fw"></span>&nbsp;删除</button>
    </div>
    <table class="display table table-striped table-bordered table-hover table-checkable text-center"
           id="codeTypeListTable" style="white-space:nowrap">
        <thead>
        <tr class="text-c">
            <th>
...
<div id='table-div2' style="width:54%;float: right;visibility: hidden">
    <div class="btn-group" style="margin-top:10px;">
        <button type="button" class="btn btn-default" onclick="addCodeFun()" style="margin-left:16px"><span
                class="fa fa-plus fa-fw"></span>&nbsp;新增
        </button>
        <button class="btn btn-default" onclick="deleteCodeListFun()"><span
                class="fa fa-trash-o fa-fw"></span>&nbsp;删除</button>
    </div>
    <table class="display table table-striped table-bordered table-hover table-checkable text-center" id="codeListTable"
...
<script type="text/javascript">
    ...
    function checkInputl() {
        var searchBasecodeForm = $('#searchBasecodeForm').serializeArray();
        $.each(searchBasecodeForm, function () {
            if (this.value != "") {
                values += this.value;
            }
        });
